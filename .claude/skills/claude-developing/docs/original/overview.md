...
<AccordionGroup>
  ...
  <Accordion title="Run agent teams and build custom agents" icon="users">
    ...
    For fully custom workflows, the [Agent SDK](agent-sdk_overview.md) lets you build your own agents powered by Claude Code's tools and capabilities, with full control over orchestration, tool access, and permissions.
  </Accordion>
...
| Build custom agents for your own workflows                                      | [Agent SDK](agent-sdk_overview.md)                                                                                |
