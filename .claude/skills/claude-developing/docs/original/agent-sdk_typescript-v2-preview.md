...
<Warning>
  The V2 interface is an **unstable preview**. APIs may change based on feedback before becoming stable. Some features like session forking are only available in the [V1 SDK](agent-sdk_typescript.md).
</Warning>
...
Not all V1 features are available in V2 yet. The following require using the [V1 SDK](agent-sdk_typescript.md):
