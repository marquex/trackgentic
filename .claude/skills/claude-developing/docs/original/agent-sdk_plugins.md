...
* [Slash Commands](agent-sdk_slash-commands.md) - Using slash commands in the SDK
* [Subagents](agent-sdk_subagents.md) - Working with specialized agents
* [Skills](agent-sdk_skills.md) - Using Agent Skills
